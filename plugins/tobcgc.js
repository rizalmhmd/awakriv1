...
const anu = {
  ...
  for (let id of groups) conn.copyNForward(id, content, 'conversation',{quoted: anu, thumbnail: fs.readFileSync('./src/awakri.jpg'), contextInfo:{externalAdReply: {title: `𝘈𝘸𝘢㉿𝘳𝘪 𝘖𝘧𝘤` , body: 'Klik disini', sourceUrl: 'https://chat.whatsapp.com/GQfybywcgb3AzNBP1zAs0h', thumbnail: fs.readFileSync('./src/awakri.jpg')}}} ,true)
