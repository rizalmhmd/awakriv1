...
let authFile = `${opts._[0] || 'awakri'}.json`
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Nah Beban masuk @user\nWelcome beban Di Grup:\n*@subject*'
  conn.bye = 'Kan beban keluar lagi @user!\nKalo Balik Jangan Lupa Bawa Gorengan Buat Anggota Disini'
  conn.spromote = 'Waduh @user Sekarang Admin'
  conn.sdemote = 'Alhamdulillah @user Sekarang Bukan Admin'
...
_quickTest()
  .then(() => conn.logger.info('Sudah dijalan dengan baik'))
  .catch(console.error)
